        ...
        <div className="mt-8 w-full rounded-2xl border border-border/50 bg-white p-6 shadow-lg shadow-foreground/5 sm:p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-lg border border-border/60 bg-white px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-gray-50"
            >
              <svg
                className="size-5"
                viewBox="0 0 24 24"
